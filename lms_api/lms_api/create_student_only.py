...
def create_account_(first_name,last_name,id_number,
    ...
    username = frappe.db.exists('User', id_number + "@wela.online")
    if username:
        ...
        exists= frappe.db.sql("""select name from `tabStudent` where first_name=%s and last_name=%s""",(first_name,last_name))
